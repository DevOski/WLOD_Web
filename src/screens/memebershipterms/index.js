      ...
      <Container>
        <Row>
          <Col className="heading">
            ...
            <p>
              {" "}
              By using the Weight Loss On Demand mobile application, or any of
              the products and services that link to this page (the "Services"),
              you agree to abide by and consent to its terms, and affirm all
              authorizations made below.
            </p>
            <h3>Description of Services</h3>
            <p>
              {" "}
              When you become a member of Weight Loss On Demand (a Member), you
              can use our mobile and web applications accessible from your
              smartphone and desktop computer that connects you to our
              professional consultants(" Professional Consultant) and support
              team. Through the Included Consultancy App, we provide
              personalized content and interactive resources for you, simple
              tools for scheduling sessions and billing, serves as your hub of
              information, and connects you to our support team.
            </p>
            ...
            <h3> Weight Loss On Demand Professional Consultant</h3>
            <p>
              . Weight Loss On Demand Professional Consultants is associated
              with but operates independently of Weight Loss On Demand. Included
              consultants does not exercise control or direction over the means,
              methods or manner by which Weight Loss On Demand Professional
              Consultants. The professional consultants provide services based
              on their sole professional judgment.
            </p>
            <p>
              We provide Consultancy services by using interactive audio, video,
              and messaging technologies through the Included Consultant App
              including care, suggestions, advice, and depending on benefits
              covered by your desired goals, primary care services, through the
              Included Consultant Application.
            </p>
            <p>
              If you need to receive follow-up sessions, assistance in the event
              of an adverse reaction to the advise, please contact us at
              281-325-0066.{" "}
            </p>
            <p>
            ...
            <p>
              Your professional consultant reserves the right to deny
              consultancy for potential misuse of the services or for any other
              reason if, in the professional judgment of your professional
              consultant, the provision of the Services is not ethically
              ...
              sessions with us, you understand that you may be terminated from
              our practice and no longer have access to our Professional
              Consultants.
            </p>
            <h3>Description of Telehealth Risks</h3>
            <p>
              Among the benefits of our services and improved access to
              consultancy and convenience. However, as with any consultant
              service, there are potential risks associated with the use of
              technology.
            </p>
            <p>These risks include, but may not be limited to:</p>
            <p>
            ...
            <p>
              {" "}
              You agree that all people or companies (third parties) who pay any
              part of your Weight Loss On Demand Professionals bill shall pay
              these amounts directly to Weight Loss On Demand Professionals. You
              understand that you must pay Weight Loss On Demand Professionals
              any costs not paid by your insurance or other third parties,
              unless state or federal regulations do not allow this.
            </p>
            ...
            <p>
              Privacy Policy By using our services, you acknowledge receipt of
              the NPP.
            </p>
            <h4>Short Message Service or SMS</h4>
            <p>
            ...
            <p>Privacy Policy,and Weight Loss On Demand's Privacy Policy.</p>
            <p>
              {" "}
              ...
              may click here to contact support or submit a message through the
              "chat" experience once logged-in. You may also call Included
              Health's general support toll free line at (855) 431-5533. If you
              send the message "STOP" to Included Health, Included Health will
              send you a reply message to confirm that you have been
              unsubscribed from SMS Communications. After this, you will no
              longer receive SMS Communications from Included Health. You agree
              that if you request to opt out from future SMS Communications,
              Included Health may send you a one-time opt-out confirmation SMS
              text message. After this, YOu will no longer receive SMS
              Communications from Included Health.
            </p>
            <p>
            ...
            <h3>Additional State-Specific Notifications:</h3>
            <p>Texas You have been informed of the following notice:</p>
            <p>
              {" "}
            ...
            <a>http://www.tmb.state.tx.us</a>
            <p>
              If you have questions or concerns about these Terms, see the below
              contact options:
            </p>
            <h4>You may contact us by mail at:</h4>
            <p>Included Health, Inc.</p>
            <p>suite 300 The Woodlands, 77384</p>
            <h5>You may email us at</h5>
            <p>support@weightlossondemand.com</p>
            <p>
              {" "}
