...
const ConfirmAndPay = () => {
  ...
  const [cuopontext, setcuopontext] = useState("Apply Coupon ");
    ...
    if (btext == "Card Added") {
      if (params?.state?.cardnumber && !params?.state?.ApplyCupon) {
            ...
            if (result.status == 200 && result.message == "succeeded") {
              if (
                ...
                formdata.append(
                  "response_1",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response1
                    : params?.state?.coupon?.data?.params?.params?.response1
                );
                formdata.append(
                  "response_2",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? JSON.stringify(
                        params.state?.data?.params?.params?.response2
                      )
                    : JSON.stringify(
                        params?.state?.coupon?.data?.params?.params?.response2
                      )
                );
                formdata.append(
                  "response_3",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response3
                    : params?.state?.coupon?.data?.params?.params?.response3
                );
                formdata.append(
                  "response_4",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response4
                    : params?.state?.coupon?.data?.params?.params?.response4
                );
                formdata.append(
                  "response_5",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response5
                    : params?.state?.coupon?.data?.params?.params?.response5
                );
                formdata.append(
                  "response_6",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response6
                    : params?.state?.coupon?.data?.params?.params?.response6
                );
                formdata.append(
                  "response_7",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response7
                    : params?.state?.coupon?.data?.params?.params?.response7
                );
                formdata.append(
                  "response_8",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response8
                    : params?.state?.coupon?.data?.params?.params?.response8
                );
                formdata.append(
                  "response_9",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.response9
                    : params?.state?.coupon?.data?.params?.params?.response9
                );
                formdata.append(
                  "response_10",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.regularexercises
                    : params?.state?.coupon?.data?.params?.regularexercises
                );
                formdata.append(
                  "response_11",
                  params.state?.data?.params?.params?.trainer?.tr_id
                ...
                formdata.append(
                  ...
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.trainer?.tr_id
                    : params?.state?.coupon?.data?.params?.params?.trainer
                        ?.tr_id
                );
                formdata.append(
                  "tr_name",
                  params.state?.data?.params?.params?.trainer?.tr_id
                    ? params.state?.data?.params?.params?.trainer?.tr_name
                    : params?.state?.coupon?.data?.params?.params?.trainer
                        ?.tr_name
                );
                  ...
                  .then((result) => {
                    ...
                    if (
                      ...
                      navigate("/Videocall", {
                        state: {
                          token,
                          tr_id: params.state?.data?.params?.params?.trainer
                            ?.tr_id
                            ? params.state?.data?.params?.params?.trainer?.tr_id
                            : params?.state?.coupon?.data?.params?.params
                                ?.trainer?.tr_id,
                        },
                      });
                    } else {
                ...
                params.state?.data?.params?.params?.trainer.vsl_time ||
                params?.state?.coupon?.data?.params?.params?.trainer.vsl_time
              ) {
                ...
                formdata.append(
                  "trainer_id",
                  params.state?.data?.params?.params?.trainer?.vsl_time
                    ? params.state?.data?.params?.params?.trainer?.vtr_id
                    : params?.state?.coupon?.data?.params?.params?.trainer
                        ?.vtr_id
                );
                formdata.append(
                  "tr_name",
                  params.state?.data?.params?.params?.trainer.vsl_time
                    ? params.state?.data?.params?.params?.trainer?.vtr_name
                    : params?.state?.coupon?.data?.params?.params?.trainer
                        ?.vtr_name
                );
                formdata.append("reason", "Weight loss");
                formdata.append(
                  ...
                  params.state?.data?.params?.params?.trainer.vsl_time
                    ? moment(
                        params.state?.data?.params?.params?.trainer?.vtr_date,
                        "DD/MM/YYYY"
                      ).format("MM/DD/YYYY")
                    : moment(
                        params?.state?.coupon?.data?.params?.params?.trainer
                ...
                formdata.append(
                  "apt_day",
                  params.state?.data?.params?.params?.trainer.vsl_time
                    ? params.state?.data?.params?.params?.trainer?.vtr_day
                    : params?.state?.coupon?.data?.params?.params?.trainer
                        ?.vtr_day
                );
                formdata.append(
                ...
                params.state?.data?.params?.params?.trainer.asl_time ||
                params?.state?.coupon?.data?.params?.params?.trainer.asl_time
              ) {
                var myHeaders = new Headers();
                myHeaders.append("Authorization", token);
                var formdata = new FormData();
                ...
                formdata.append(
                  ...
                  params.state?.data?.params?.params?.trainer.asl_time
                    ? moment(
                        params.state?.data?.params?.params?.trainer?.atr_date,
                        "DD/MM/YYYY"
                      ).format("MM/DD/YYYY")
                    : moment(
                        params?.state?.coupon?.data?.params?.params?.trainer
                ...
                formdata.append(
                  "apt_day",
                  params.state?.data?.params?.params?.trainer.asl_time
                    ? params.state?.data?.params?.params?.trainer?.atr_day
                    : params?.state?.coupon?.data?.params?.params?.trainer
                        ?.atr_day
                );
                formdata.append(
        ...
        formdata.append(
          ...
          params?.state?.coupon?.cardnumber
            ? params?.state?.coupon?.cardnumber
            : params?.state.cardnumber
        );
        formdata.append(
          "expr_num",
          params?.state?.coupon?.Expiration
            ? params?.state?.coupon?.Expiration
            : params?.state.Expiration
        );
        formdata.append(
          "exp_year",
          params?.state?.coupon?.ExpirationYY
            ? params?.state?.coupon?.ExpirationYY
            : params?.state.ExpirationYY
        );
        formdata.append(
          "cvc",
  ...
  return (
    <div className="of">
      <BasicExample />
      <Row className="d-flex justify-content-center flex-column align-items-center gap-5 pt-5 payment-btns">
        <Col
          lg="12"
