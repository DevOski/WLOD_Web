...
const Confirmpay = () => {
  ...
  return (
    ...
    <div className="of">
     ...
     <Col lg='12' className="d-flex justify-content-center  align-items-center con-col">
     <Form>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Credit card number</Form.Label>
        <Form.Control type="numberic" placeholder="Add your credit card number" onChange={event =>  setcardnumber(event.target.value)} />
      ...
      <Form.Group className="mb-3" controlId="formBasicPassword">
        ...
        <Form.Control type="text" placeholder="Expiration(MM)" onChange={event =>  setExpiration(event.target.value)} />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>Cvv</Form.Label>
        <Form.Control type="text" placeholder="Cvv" onChange={event =>  setCvv(event.target.value)}  />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicPassword">
        <Form.Label>Expiration(YY)</Form.Label>
        <Form.Control type="text" placeholder="Expiration(YY)" onChange={event =>  setExpirationYY(event.target.value)}  />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicCheckbox">
        <Form.Check type="checkbox" label="Check me out" checked={isChecked} onChange={handleOnChange} />
      </Form.Group>
      <Button variant="primary" className="comfirm-pay-submit">
        Submit
      </Button>
    </Form>
     </Col>
